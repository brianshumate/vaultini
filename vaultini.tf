...
locals {
 vault_containers = {
   ...
   "vaultini2" = { ipv4_address = "10.1.42.102", env = ["SKIP_CHOWN", "VAULT_CLUSTER_ADDR=https://10.1.42.102:8201", "VAULT_REDIRECT_ADDR=https://10.1.42.102:8200","VAULT_CACERT=/vault/certs/vaultini-ca.pem"], internal_port = "8200", external_port = "8220", host_path_certs = "${path.cwd}/containers/vaultini2/certs", host_path_config = "${path.cwd}/containers/vaultini2/config", host_path_data = "${path.cwd}/containers/vaultini2/data", host_path_logs = "${path.cwd}/containers/vaultini2/logs"},
   "vaultini3" = { ipv4_address = "10.1.42.103", env = ["SKIP_CHOWN", "VAULT_CLUSTER_ADDR=https://10.1.42.103:8201", "VAULT_REDIRECT_ADDR=https://10.1.42.103:8200","VAULT_CACERT=/vault/certs/vaultini-ca.pem"], internal_port = "8200", external_port = "8230", host_path_certs = "${path.cwd}/containers/vaultini3/certs", host_path_config = "${path.cwd}/containers/vaultini3/config", host_path_data = "${path.cwd}/containers/vaultini3/data", host_path_logs = "${path.cwd}/containers/vaultini3/logs"},
   "vaultini4" = { ipv4_address = "10.1.42.104", env = ["SKIP_CHOWN", "VAULT_CLUSTER_ADDR=https://10.1.42.104:8201", "VAULT_REDIRECT_ADDR=https://10.1.42.104:8200","VAULT_CACERT=/vault/certs/vaultini-ca.pem"], internal_port = "8200", external_port = "8240", host_path_certs = "${path.cwd}/containers/vaultini4/certs", host_path_config = "${path.cwd}/containers/vaultini4/config", host_path_data = "${path.cwd}/containers/vaultini4/data", host_path_logs = "${path.cwd}/containers/vaultini4/logs"},
   "vaultini5" = { ipv4_address = "10.1.42.105", env = ["SKIP_CHOWN", "VAULT_CLUSTER_ADDR=https://10.1.42.105:8201", "VAULT_REDIRECT_ADDR=https://10.1.42.105:8200","VAULT_CACERT=/vault/certs/vaultini-ca.pem"], internal_port = "8200", external_port = "8250", host_path_certs = "${path.cwd}/containers/vaultini5/certs", host_path_config = "${path.cwd}/containers/vaultini5/config", host_path_data = "${path.cwd}/containers/vaultini5/data", host_path_logs = "${path.cwd}/containers/vaultini5/logs"}
 }
}
